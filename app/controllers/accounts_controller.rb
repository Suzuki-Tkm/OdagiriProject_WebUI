class AccountsController < ApplicationController
  ...
  def show
    if current_user
      data = current_user.values_at(:id  , :pictureStyle , :painting_taste ,:personality , :portrait_LandscapePainting , :nature_population , :tradition_revolution , :conservative_active ,:image_recognition , :voice_recognition_brightness , :voice_recognition_weather).to_json.gsub(/"/, '')
